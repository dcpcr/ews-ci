<div class="card">
    <div class="card-header">
        <h3 class="card-title">Grievance Registered with DCPCR</h3>
        <p class="card-body">Undertake interventions at a school-level to prevent the below mentioned grievances from
            happening.</p>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
        <table id="example1" class="table table-bordered table-striped">
            ...
            <tr>
                <td>2</td>
                <td>Update Status After Home Visit</td>
                <td>0</td>
                <td class="project_progress">
                    <div class="progress progress-sm">
                        <div class="progress-bar bg-blue" role="progressbar" aria-valuenow="7" aria-valuemin="0"

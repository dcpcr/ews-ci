...
if (!empty($response['bts_with_intervention_list'])) {
    $data = $response['bts_with_intervention_list'];
} elseif (!empty($response['bts_without_intervention_list'])) {
    $data = $response['bts_without_intervention_list'];
}

        ...
        <div class="card">
            ...
            <div class="card-body px-5 py-5">
                ...
                <div class="row text-center">
                    ...
                    <div class="col mx-1">
                        <div class="knob-label pb-3"><strong>Back to School</strong>
                            <span class="fa fa-info-circle" data-toggle="tooltip" data-placement="right"
                    ...
                    <div class="col mx-1">
                        <div class="knob-label pb-3"><strong>Untraceable</strong>
                            <span class="fa fa-info-circle" data-toggle="tooltip" data-placement="right"
                                  title="Cases wherein no contact could be established throughout (phone calls and home-visit).">

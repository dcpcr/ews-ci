                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-6 col-md-2 text-center">
                            ...
                            <input disabled type="text" class="knob" id="total" value="<?=count($response)?>" data-skin="tron"
...
"></span>
                        ...
                        <div class="col-6 col-md-2 text-center">
                            <div class="knob-label pb-3"><strong>Back to School</strong> <span class="fa fa-info-circle"
                                                                                               ...
                                                                                               title="When a high risk student re-joins the school (attends the school at least a day from the long absence)."></span></div>
                        ...
                        <div class="col-6 col-md-2 text-center ">
                            <div class="knob-label pb-3"><strong>Yet to be contacted</strong> <span
                                        ...
                                        title="Fresh cases or the cases wherein the first call is yet to be attempted."></span></div>

...
<div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand  navbar-light">
        <?= $this->include('dashboard/partial/top-nav-bar'); ?>
    </nav>
    <aside class="main-sidebar sidebar-light-primary elevation-1">
        <?= $this->include('dashboard/partial/brand-logo-name'); ?>
        <?= $this->include('dashboard/partial/left-nav-bar'); ?>
    </aside>

    <div class="content-wrapper">
        <?= $this->include('dashboard/partial/page-header-details'); ?>

        <!-- Main content -->
        <div class="content">
            <div class="container-fluid">
                <?= $this->include('dashboard/partial/filters'); ?>

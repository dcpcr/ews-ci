var Encryption = (function ($) {
    ...
    var encrypt = function (data, key) {
        ...
        var hashKey = CryptoJS.PBKDF2(key, __salt, {
...
function encrypt() {
    ...
    if (password !== null) {
        Encryption.getInstance().setKey(key);
        const encrypted_password = Encryption.getInstance().encrypt(password);

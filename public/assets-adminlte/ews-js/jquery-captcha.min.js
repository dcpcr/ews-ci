...
function validate(){
    ...
    if(ans==true)
    {
        ...
        $( document ).ready(function() {
            ...
            $('#error').html('Please enter valid CAPTCHA');
        });
        return false;
    }
}
$(function () {
  ...
  $("#casetable")
    .DataTable({
      ...
      // columnDefs: [{ visible: false, targets: [10, 11, 17, 15, 2, 4] }],
      responsive: false,
      lengthChange: true,
      autoWidth: false,
      ordering: true,
      ...
      //   ],
      dom:
        "<'row'<'col-sm-12 col-md-6'B><'col-sm-12 col-md-4'f><'col-sm-12 col-md-2'l>>" +
        "<'row'<'col-sm-12'tr>>" +
    ...
    .buttons()
    .container()
    .appendTo("#casetable_wrapper .col-md-6:eq(0)");
});
...
$.fn.dataTable.ext.buttons.download = {
  ...
  action: function (e, dt, node, config) {
    ...
    $.ajax({
      ...
      $.fn.dataTable.fileSave(new Blob([csv]), "Export.csv");
    });
  },
};
